...
chart.create_gantt(save_dir+"/output/solution"+solution_ctn+"_tasklist.json", 
    save_dir+"/result/"+folder_name+"_sol"+solution_ctn+"_", schedule
)
print("gantt chart generated")
# excel
json_tasklist_path = save_dir+"/output/solution"+solution_ctn+"_tasklist.json"
excel_tasklist_path = save_dir+"/result/"+folder_name+"_sol"+solution_ctn+"_tasklist"
...
excel_labortime_path = save_dir+"/result/"+folder_name+"_sol"+solution_ctn+"_labortime"
...
chart.create_labor_chart(
    ...
    save_dir+"/result/"+folder_name+"_sol"+solution_ctn+"_"
)
