...
def flexible_jobshop():
    ...
    jobs = [  # task = (processing_time, machine_id)
        [  # Zone(Job) 0
            [(2, 0), (2, 1), (5, 2), (3, 3)],  # task 0 with 3 alternatives
            [(3, 0), (3, 1), (6, 2), (3, 3)],  # task 1 with 3 alternatives
            [(4, 0), (5, 1), (1, 2), (3, 3)],  # task 2 with 3 alternatives
        ],
        [  # Zone(Job) 1
            [(4, 0), (1, 1), (4, 2), (3, 3)],
            [(5, 0), (6, 1), (4, 2), (3, 3)],
        ...
        for task_id in range(len(jobs[job_id])):
            ...
            for alt_id in range(len(jobs[job_id][task_id])):
                if solver.Value(presences[(job_id, task_id, alt_id)]):
                    ...
                    selected = alt_id
            print(
                '  Task_%i starts at %i (alt %i, Team %i, Duration %i)' %
